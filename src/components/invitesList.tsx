import { View, Text, Pressable, FlatList, TouchableOpacity, Image, ImageBackground } from "react-native";
    ...
    if (loading) {
        return (
            <View className="flex-1 justify-center items-center">
                <Text className="text-white mb-4">What adventures are your friends up to...</Text>
            ...
            renderItem={({ item }) => (
                ...
                >
                    <ImageBackground
                        ...
                        style={{ height: 160 }}
                    >
                        <BlurView intensity={20} tint="dark" className="flex-1 px-4 py-4 justify-between">
